...
$plugin_tx['register']['user_deleted']="User '%s' deleted!";
...
$plugin_tx['register']['entries_in_csv_0']="%d entries in CSV file '%s'";
$plugin_tx['register']['entries_in_csv_1']="%d entry in CSV file '%s'";
$plugin_tx['register']['entries_in_csv_2_4']="%d entries in CSV file '%s'";
$plugin_tx['register']['entries_in_csv_5']="%d entries in CSV file '%s'";
