...
$plugin_tx['register']['err_status_empty']="No validation code supplied!";
...
$plugin_tx['register']['register_form2']="After successful registration, an email with instructions to activate the account will be sent to you.";
