...
$plugin_tx['register']['error_in_user']="Error for user '%s':";
...
$plugin_tx['register']['err_username_does_not_exist']="The username '%s' does not exist!";
...
$plugin_tx['register']['csv_written']="CSV file '%s' successfully written!";
