<?php
	...
	$plugin_tx['register']['err_username_exists']="Toto uživatelské jméno již existuje.";
	...
	$plugin_tx['register']['err_validation']="Ověřovací kód je chybný.";
	...
	$plugin_tx['register']['mnu_main']="Správa uživatelů/skupin";
	$plugin_tx['register']['mnu_config']="Konfigurace";
	...
	$plugin_tx['register']['err_too_many_users']="Příliš mnoho uživatelů!";
	$plugin_tx['register']['cf_allowed_register']="<b>true</b>umožňuje registraci pro nové členy.</b>";
	$plugin_tx['register']['cf_captcha_mode']="<b>none</b> deaktivuje captcha.</b> <b>formula</b> aktivuje vzorec založený na captcha.</b> <b>image</b> aktivuje obrázek založený na captcha.</b>";
	$plugin_tx['register']['cf_encrypt_password']="<b>true</b> aktivuje šifrování hesla.</b>";
	$plugin_tx['register']['cf_fix_mail_headers']="<b>true</b> řeší problémy s některými chybnými agenty Mail Transfer. Použijte jej, pokud nechcete dostávat e-maily či pokud některé z informací v hlavičce (např. \"MIME-Version: 1.0\") jsou vidět v těle pošty.";
	$plugin_tx['register']['cf_group_activated']="Status nových členů (skupina po registraci a aktivaci účtu).";
	$plugin_tx['register']['cf_group_administrator']="Skupina s administrátorskými právy";
