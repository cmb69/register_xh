...
$plugin_tx['register']['entries_in_csv_0']="%d Einträge in CSV Datei '%s'";
$plugin_tx['register']['entries_in_csv_1']="%d Eintrag in CSV Datei '%s'";
$plugin_tx['register']['entries_in_csv_2_4']="%d Einträge in CSV Datei '%s'";
$plugin_tx['register']['entries_in_csv_5']="%d Rinträge in CSV Datei '%s'";
